...
if ! [ -z $MODULE ];then
    if [[ $MODULE == 'nginx' ]];then
        ...
        rsync -a  ${SELF_DIR}/../support-files/templates/nginx/paas.conf /etc/consul-template/templates/
        rsync -a  ${SELF_DIR}/../support-files/templates/nginx/cmdb.conf /etc/consul-template/templates/
        rsync -a  ${SELF_DIR}/../support-files/templates/nginx/job.conf /etc/consul-template/templates/
