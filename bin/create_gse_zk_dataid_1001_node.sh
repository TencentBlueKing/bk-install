...
redis_storage="[{\"type\":1,\"biz_id\":$bk_biz_id,\"cluster_index\":1,\"data_set\":\"snapshot\",\"msg_system\":3,\"partition\":0}]"

$zkbin -server "$gse_zk_addr" create /gse/config/etc/dataserver/data/1001 "$redis_storage"

# create redis storage
redis_host="[{\"host\":\"$BK_CMDB_REDIS_SENTINEL_HOST\",\"port\":$BK_CMDB_REDIS_SENTINEL_PORT,\"type\":3,\"passwd\":\"$BK_CMDB_REDIS_PASSWORD\",\"mastername\":\"$BK_CMDB_REDIS_MASTER_NAME\"}]"
