...
export BK_APIGW_API_HOST=$BK_APIGW_APIGATEWAY_CONSUL_SERVICE:$BK_APIGW_APIGATEWAY_HTTP_PORT
export BK_APIGW_HTTP_HOST=$BK_APIGW_DASHBOARD_CONSUL_SERVICE:$BK_APIGW_DASHBOARD_HTTP_PORT
set +u
