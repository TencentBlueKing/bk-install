...
class Action(Storage_Check):
    ...
    def bkmonitorv3(self):
        ...
        self.check_redis_by_get_mastername(
            ...
            single_host = monitorv3_check_env_dict['BK_MONITOR_REDIS_SENTINEL_HOST'],
            single_port = monitorv3_check_env_dict['BK_MONITOR_REDIS_SENTINEL_PORT'],
    ...
    def bknodeman(self):
        ...
        self.check_redis_by_get_mastername(
            ...
            single_host = nodeman_check_env_dict['BK_NODEMAN_REDIS_SENTINEL_HOST'],
            single_port = nodeman_check_env_dict['BK_NODEMAN_REDIS_SENTINEL_PORT'],
