...
map_module_name () {
    ...
    case $module in
        ...
        bkiam_engine|iam_engine)  name=bkiam_engine ;;
...
add_saas_skip_auth () {
    local base_saas_list=(bk_iam bk_user_manage bk_sops bk_nodeman bk_monitorv3 bk_log_search bk_itsm bk_fta_solutions)
